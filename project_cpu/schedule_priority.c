...
void add(char *name, int priority, int burst){
   ...
   struct node *temp = head;
    //According to the priority scheduling principle, we put the tasks into the list in the order of priority from the largest to the smallest//
...
int total_waiting_time()
{
  ...
  //The total waiting time of Priority Scheduling is same as First-Come First-Served Scheduling//
...
//Because in Priority Scheduling, Task is run all the brust at once. //
